...
<head>
    ...
    <title>ConfirmationSignUp</title>
        ...
        <div class="row mh-100vh">
            <div class="col-10 col-sm-8 col-md-6 col-lg-6 offset-1 offset-sm-2 offset-md-3 offset-lg-0 align-self-center d-lg-flex align-items-lg-center align-self-lg-stretch bg-white p-5 rounded rounded-lg-0 my-5 my-lg-0" id="login-block">
                <div class="m-auto w-lg-75 w-xl-50">
                    ...
                    ?>
                    <form action="Scripts/ConfirmationSignUp.php" method="POST">

                        <div class="form-group">
                            <label class="text-secondary">Enter The Confirmation Code:</label>
                            <input name="confirmation" class="form-control" type="text" pattern="[0-9]{6}" max="6" required="" min="6">
                        </div>

                        <button name="submit" class="btn btn-info mt-2" type="submit">Sign Up</button>
                    </form>
                </div>
            </div>
